...
@Component("clientAdapterMessage")
public class ClientAdapterMessage implements AdapterMessage {
	...
	//订阅请求结果消息处理
	@Resource(name="clientSubscribeHandle")
	private MessageHandle<SubProtocol> clientSubscribeHandle;
	//订阅请求结果消息处理
	@Resource(name="clientUnsubscribeHandle")
	private MessageHandle<UnsubProtocol> clientUnsubscribeHandle;
	//申请数据同步请求消息返回处理
	@Resource(name="clientApplyHandle")
	private MessageHandle<ApProtocol> clientApplyHandle;
	//数据消息
